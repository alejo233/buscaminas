...
public class Casilla {
	...
	/**
	 * Atributo que indica si la casilla es mina
	 */
	 ...
	 * @return El String con la representaci�n actual de la casilla
	 */
	...
	/**
	 *  Metodo modificar del atributo mina 
	 * @param mina - nueva mina
	 */
	public void modificarMina(boolean mina) {
		this.mina = mina;
	}
